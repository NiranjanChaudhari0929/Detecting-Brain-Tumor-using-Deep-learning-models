...
# # Define the input shape for MobileNetV2 with lower resolution
# input_shape = (128, 128, 3)  # Reduced resolution
...
#         # Load and preprocess the image (resize to input_shape, convert to RGB, normalize, etc.) as needed
...
# # Freeze the layers of the pre-trained base model (optional)
...
# plt.title('Confusion Matrix for Media Net V2')
...
# plt.title('Accuracy vs. Epochs for Media Net V2')
# plt.xlabel('Epochs')
# plt.ylabel('Accuracy')
# plt.legend()
# plt.show()
